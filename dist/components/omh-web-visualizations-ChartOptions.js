( function( root, factory ) {
  ...
  parent.ChartOptions = function( settings ){
    ...
    var mergedSettings = parent.Utils.mergeObjects(defaultSettings, settings);

    d3.keys( mergedSettings.measures ).forEach(function( measure ) {
